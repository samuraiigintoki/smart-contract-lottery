...
contract RaffleTest is Test {
    ...
    function testRaffleRevertsWhenYouDontPayEnough() public {
        ...
        vm.expectRevert(Raffle.Raffle__NotEnoughToEnterRaffle.selector);
        raffle.enterRaffle();
    }
    ...
    function testDontAllowPlayerWhenRaffleIsCalculating() public {
        vm.prank(PLAYER);
    ...
    function testPerformUpkeepRevertsWhenCheckUpkeepFails() public {
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entrancefee}();
        vm.roll(block.number + 1);
    ...
    function testPerformUpkeepRevertsIfRaffleIsNotOpen() public {
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entrancefee}();
        vm.warp(block.timestamp + interval + 1);
        vm.roll(block.number + 1);
    ...
    function testPerformUpkeepUpdateRaffleStateAndEmitsRequestId() public {
        ...
        vm.recordLogs(); // records logs emited by event/function
        raffle.performUpkeep("");
